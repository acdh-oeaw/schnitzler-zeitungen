#!/usr/bin/env bash
# start-server.sh
echo "Hello from Project Schnitzler-Zeitungen"
...
echo $TRANSKRIBUS_COL
gunicorn schnitzler_zeitungen.wsgi --user www-data --bind 0.0.0.0:8010 --workers 3 & nginx -g "daemon off;"